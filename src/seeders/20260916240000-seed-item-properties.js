...
// Preenche as tabelas satélite dos 3 itens do seed anterior: capacete
// (ArmorProperties), espada (WeaponProperties) e poção (consumable_properties).
module.exports = {
  ...
  async down(queryInterface) {
    ...
    await queryInterface.bulkDelete("consumable_properties", { id_item: 3 });
  },
};
